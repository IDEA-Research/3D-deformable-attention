...
class PerceptionTransformer_DFA3D(PerceptionTransformer):
    ...
    @auto_fp16(apply_to=('mlvl_feats', 'mlvl_dpt_dists', 'bev_queries', 'prev_bev', 'bev_pos'))
    def get_bev_features(
            self,
            mlvl_feats,
            mlvl_dpt_dists,
    ...
    @auto_fp16(apply_to=('mlvl_feats', 'mlvl_dpt_dists', 'bev_queries', 'object_query_embed', 'prev_bev', 'bev_pos'))
    def forward(self,
                mlvl_feats,
                mlvl_dpt_dists,
                bev_queries,
