...
class BEVFormerEncoder_DFA3D(BEVFormerEncoder):
    def __init__(self, *args, pc_range=None, d_bound=[2.0, 58, 3.5], num_points_in_pillar=4, return_intermediate=False, dataset_type='nuscenes', **kwargs):
        super().__init__(*args, pc_range=pc_range, num_points_in_pillar=num_points_in_pillar, return_intermediate=return_intermediate, dataset_type=dataset_type, **kwargs)
